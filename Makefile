...
HYPRE_F64_I64_VER = 2.25.0-i64
HYPRE_F64_I64_HOME = $(SOFT_HOME)/hypre/$(HYPRE_F64_I64_VER)
HYPRE_F64_I64_LIB  = $(HYPRE_F64_I64_HOME)/lib
HYPRE_F64_I64_INCLUDE = $(HYPRE_F64_I64_HOME)/include
L_F64_I64_HYPRE = -L$(HYPRE_F64_I64_LIB) -lHYPRE
...
CXX= mpicxx
CFLAGS = -O3 -std=c++11 -fopenmp -g -DTEST_CNT=5

CL = mpicxx
LFLAGS = -lm -fopenmp -ldl

all:	base_struct_f64.exe\
	base_struct_f32.exe\
	base_IJ_f32.exe\
	base_IJ_f64.exe\
	base_IJ_f64_i64.exe\
	base_IJ_f32_i64.exe\
	base_sstruct_f64.exe#\
...
base_IJ_f64_i64.exe : base_IJ.c
	$(CXX) $(CFLAGS) -I$(HYPRE_F64_I64_INCLUDE) $^ $(L_F64_I64_HYPRE) $(LFLAGS) -o $@
